...
let NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      {
        icon: "https://img.alicdn.com/imgextra/i1/O1CN01RSfkps1J0vtVaKr0U_!!6000000000967-49-tps-1920-1920.webp",
        title: "Angular",
      ...
      },
      {
        ...
        title: "NG-ZORRO",
        desc: "ng-zorro-antd 是遵循 Ant Design 设计规范的 Angular UI 组件库，主要用于研发企业级中后台产品。全部代码开源并遵循 MIT 协议，任何企业、组织及个人均可免费使用。",
  ...
  },
  {
    ...
    items: [
      {
        icon: "https://lesscss.cn/public/img/less_logo.png",
        title: "Less",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "MingCute",
        desc: "MingCute是一套简单精致的开源图标库。无论你是设计师还是开发人员，它都非常适合在网页和移动设备上使用。",
