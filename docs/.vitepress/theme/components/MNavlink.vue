...
const insertHistorys = () => {
    store.insertHistory(props)
}
</script>

<template>
    <a v-if="link" class="m-nav-link" :href="link" target="_blank" rel="noreferrer" @click="insertHistorys()">
        <article class="box">
            ...
            <span v-if="badge" class="VPBadge badge info ">{{ badge }}</span>
        </article>
    </a>
</template>
