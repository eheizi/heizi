...
// 对象实例
const person1 = new Person("heizi");
const personal1 = new Personal("heizi");
console.log(person1); // Person {name: 'heizi'}
console.log(personal1); // Person {name: 'heizi'}
```
...
![prototype](./image/prototype/prototype.jpg)
...
console.log(person1.name, person2.name); // 'heizi' 'heizi'
```
...
![constructor](./image/prototype/constructor.jpg)
...
![**proto**](./image/prototype/__proto__.jpg)
...
![prototypes](./image//prototype/prototypes-1.jpg)
